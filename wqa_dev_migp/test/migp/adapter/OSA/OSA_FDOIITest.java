...
import migp.adapter.mock.FDOIIMock;
 ...
 * @author chejf
 */
public class OSA_FDOIITest {

    public OSA_FDOIITest() throws Exception {
        if (dev_mock == null) {
            this.InitDevice();
        }
    }
    ...
    public void testCollectData() throws Exception {
        ...
        MEG[] regs = new MEG[]{dev_mock.MPAR1, dev_mock.MPAR2, dev_mock.SR1, dev_mock.MPAR3, dev_mock.SR2, dev_mock.SR3, dev_mock.SR4, dev_mock.SR5, dev_mock.SR6, dev_mock.SR7};
