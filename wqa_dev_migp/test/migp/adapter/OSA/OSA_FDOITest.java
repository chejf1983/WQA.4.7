 ...
 * @author chejf
 */
public class OSA_FDOITest {

    public OSA_FDOITest() throws Exception {
        if (dev_mock == null) {
            this.InitDevice();
        }
    }
