 ...
 * @author chejf
 */
public class ECMock extends DevMock {

    // <editor-fold defaultstate="collapsed" desc="NVPA"> 
    public FMEG NA = new FMEG(new NVPA(36, 4), "电导率参数A");
    public FMEG NTEMP_COM = new FMEG(new NVPA(40, 4), "温度补偿系数");
    ...
    public ECMock() {
        super();
        this.client.RegisterREGS(NTEMP_COM, NA, NTEMP_CAL,
    ...
    public void ResetREGS() throws Exception {
        super.ResetREGS();
        MEG[] list = new MEG[]{NTEMP_COM, NA, NTEMP_CAL,
            VDRANGE_MIN, VDRANGE_MAX, VTRANGE_MIN, VTRANGE_MAX, VVATOKEN,
            MALARM, MPAR1, MPAR2, MPAR3,
            SR1, SR2, SR3, SR4, SR5, SR6, SR7};
