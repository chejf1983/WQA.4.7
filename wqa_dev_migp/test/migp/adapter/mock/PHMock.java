 ...
 * @author chejf
 */
public class PHMock extends DevMock {

    // <editor-fold defaultstate="collapsed" desc="NVPA"> 
    public DMEG NE0 = new DMEG(new NVPA(0, 8), "PH系数E0");
    public DMEG NA = new DMEG(new NVPA(8, 8), "PH系数A");
    ...
    public PHMock() {
        super();
        this.client.RegisterREGS(NE0, NA, NTEMP_CAL,
    ...
    public void ResetREGS() throws Exception {
        super.ResetREGS();
        MEG[] list = new MEG[]{NE0, NA, NTEMP_CAL,
            VDRANGE_MIN, VDRANGE_MAX, VTRANGE_MIN, VTRANGE_MAX, VVATOKEN,
            MALARM, MPAR1, MPAR2, MPAR3,
            SR1, SR2, SR3, SR4, SR5, SR6, SR7};
