 ...
 * @author chejf
 */
public class OSA_NX extends AbsDevice {
...
//    FMEG SR2 = new FMEG(new SRA(0x04, 4), "4.096V基准电压");
    ...
    public OSA_NX(SDevInfo devinfo) {
        super(devinfo);
    }
    ...
    public void InitDevice() throws Exception {
        ...
        //NVPA初始化
        this.ReadMEG(NRANGE, NAVR, NCTIME, NCINTERVAL, NCBRUSH,
    ...
    public LogNode CalParameter(String type, float[] oradata, float[] testdata) throws Exception {
        ...
        if (type.contentEquals("温度")) {
            ...
            ret.children.add(new LogNode(NTEMPER_PAR.toString(), cal_par));
        } else {
