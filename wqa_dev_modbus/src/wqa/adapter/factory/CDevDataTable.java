...
public class CDevDataTable {
    ...
    private void initInfoTable() {
        DevInfo[] d_list = new DevInfo[]{
            ...
            new DevInfo(0x0205, "ESA_CHLORI_II", "余氯", new DataInfo("余氯", 3, "ppm", 2, "(0-5)"), new DataInfo("余氯" + ORA_Flag, 3, "mV", 0, true, ""), new DataInfo("pH", 2, "", 2, "(0-14)"), new DataInfo("pH" + ORA_Flag, 2, "mV", 0, true, ""), new DataInfo("ORP", 1, "", 2, "(0-14)"), new DataInfo("ORP" + ORA_Flag, 1, "mV", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
