...
public class CDevDataTable {
    ...
    private void initInfoTable() {
        DevInfo[] d_list = new DevInfo[]{
            ...
            new DevInfo(0xA210, "OSA_FDOII", "溶解氧FDO", new DataInfo("溶解氧", 2, "mg/L", 0x02, "(0-20)"), new DataInfo("溶解氧百分比", 2, "%", 0, ""), new DataInfo("相位差", 1, "", 0, true, "度"), new DataInfo("蓝光幅值", 1, "", 0, true, ""), new DataInfo("参考蓝光幅值", 1, "", 0, true, ""), new DataInfo("红光幅值", 1, "", 0, true, ""), new DataInfo("信号偏置", 1, "", 0, true, ""), new DataInfo("溶解氧" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            //MPA_ESA0x12系列
            ...
            new DevInfo(0xA110, "OSA_FDOII", "溶解氧FDO", new DataInfo("溶解氧", 2, "mg/L", 0x02, "(0-20)"), new DataInfo("溶解氧百分比", 2, "%", 0, ""), new DataInfo("溶解氧" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, ""), new DataInfo("相位差", 1, "", 0, true, "度"), new DataInfo("蓝光幅值", 1, "", 0, true, ""), new DataInfo("参考蓝光幅值", 1, "", 0, true, ""), new DataInfo("红光幅值", 1, "", 0, true, ""), new DataInfo("信号偏置", 1, "", 0, true, "")),
            //MPA_OSA0x11系列
