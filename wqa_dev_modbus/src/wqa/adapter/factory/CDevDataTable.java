...
public class CDevDataTable {
    ...
    private void initInfoTable() {
        DevInfo[] d_list = new DevInfo[]{
            ...
            new DevInfo(0xA210, "OSA_FDOII", "溶解氧FDO", new DataInfo("溶解氧", 2, "mg/L", 0x02, "(0-20)"), new DataInfo("溶解氧百分比", 2, "%", 0, ""), new DataInfo("溶解氧" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, ""), new DataInfo("相位差", 1, "", 0, true, "度"), new DataInfo("蓝光峰值", 1, "", 0, true, ""), new DataInfo("激发信号", 1, "", 0, true, ""), new DataInfo("红光峰值", 1, "", 0, true, ""), new DataInfo("信号偏置", 1, "", 0, true, ""), new DataInfo("蓝光幅值", 1, "", 0, true, ""), new DataInfo("红光幅值", 1, "", 0, true, "")),
            //MPA_ESA0x12系列
            ...
            new DevInfo(0x0108, "OSA_CYANO", "蓝绿藻", new DataInfo("蓝绿藻", 1, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            ...
            new DevInfo(0xA110, "OSA_FDOII", "溶解氧FDO", new DataInfo("溶解氧", 2, "mg/L", 0x02, "(0-20)"), new DataInfo("溶解氧百分比", 2, "%", 0, ""), new DataInfo("溶解氧" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, ""), new DataInfo("相位差", 1, "", 0, true, "度"), new DataInfo("蓝光峰值", 1, "", 0, true, ""), new DataInfo("激发信号", 1, "", 0, true, ""), new DataInfo("红光峰值", 1, "", 0, true, ""), new DataInfo("信号偏置", 1, "", 0, true, ""), new DataInfo("蓝光幅值", 1, "", 0, true, ""), new DataInfo("红光幅值", 1, "", 0, true, "")),
            //MPA_OSA0x11系列
            ...
            new DevInfo(0x1103, "MOSA_CYANO_I", "蓝绿藻", new DataInfo("蓝绿藻", 1, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            new DevInfo(0x1104, "MOSA_CYANO_II", "蓝绿藻", new DataInfo("蓝绿藻", 1, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            ...
            new DevInfo(0x1111, "MOSA_CYANO_I Pro", "微型藻密度传感器", new DataInfo("蓝绿藻(淡)", 2, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻(淡)" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("浊度", 1, "NTU", 3, "(0-100)", "(0-500)", "(0-2000)", "(0-4000)"), new DataInfo("浊度" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            new DevInfo(0x1112, "MOSA_CYANO_II Pro", "微型藻密度传感器", new DataInfo("蓝绿藻(海)", 2, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻(海)" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("浊度", 1, "NTU", 3, "(0-100)", "(0-500)", "(0-2000)", "(0-4000)"), new DataInfo("浊度" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            new DevInfo(0x1113, "MOSA_TA_I", "微型总藻传感器", new DataInfo("叶绿素", 2, "ug/L", 3, "(0-500)", "(0-50)"), new DataInfo("叶绿素" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("蓝绿藻(淡)", 1, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻(淡)" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            new DevInfo(0x1114, "MOSA_TA_II", "微型总藻传感器", new DataInfo("叶绿素", 2, "ug/L", 3, "(0-500)", "(0-50)"), new DataInfo("叶绿素" + ORA_Flag, 2, "", 0, true, ""), new DataInfo("蓝绿藻(海)", 1, "细胞/ul", 3, "(0-2000)", "(0-200)"), new DataInfo("蓝绿藻(海)" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, "")),
            //ISA0x03系列
            ...
            new DevInfo(0x0320, "ISA_CHLORINE", "", new DataInfo("Cl", 1, "mg/L", 2, ""), new DataInfo("Cl" + ORA_Flag, 1, "", 0, true, ""), new DataInfo("温度", 0, "℃", 1, "(0-60)"), new DataInfo("温度" + ORA_Flag, 0, "", 0, true, ""))};
        //MISA0x13系列
